            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong class="text-secondary">Ferreteria</strong><strong class="text-white">mania</strong></div>
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="bg-info">
            ...
            <div class="sidebar-header d-flex align-items-center p-1">
                <div class="avatar" data-toggle="modal" data-target="#cambiarPass"><img src="<?php echo base_url(); ?>/Assets/img/logo_1.jpg" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
